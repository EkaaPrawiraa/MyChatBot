...
import { automationService, type AutomationCreateRequest, type AutomationUpdateRequest } from '@/src/services/automation-service'
...
export function useCreateAutomation() {
  ...
  return useMutation({
    mutationFn: (request: AutomationCreateRequest) => automationService.createAutomation(request),
    onSuccess: () => {
...
export function useUpdateAutomation(id: string) {
  ...
  return useMutation({
    mutationFn: (request: AutomationUpdateRequest) => automationService.updateAutomation(id, request),
    onSuccess: () => {
...
export function useDeleteAutomation(id: string) {
  ...
  return useMutation({
    mutationFn: () => automationService.deleteAutomation(id),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: QUERY_KEYS.AUTOMATIONS })
    },
  })
